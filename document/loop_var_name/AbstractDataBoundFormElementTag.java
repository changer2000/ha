...
public abstract class AbstractDataBoundFormElementTag extends AbstractFormTag implements EditorAwareTag {
	...
	protected final String getPath() throws JspException {
		...
		return parsePath((resolvedPath != null ? resolvedPath : ""));	//XXX old : (resolvedPath != null ? resolvedPath : "")
	}
	
	protected String parsePath(String path) throws JspException {
		...
		while (matcher.find()) {
			String replacedStr = matcher.group();
			if (org.apache.commons.lang.StringUtils.isNotBlank(replacedStr)) {
				replacedStr = org.apache.commons.lang.StringUtils.replace(replacedStr, "[", "");
				replacedStr = org.apache.commons.lang.StringUtils.replace(replacedStr, "]", "");
				Object object = this.pageContext.getAttribute(replacedStr, PageContext.PAGE_SCOPE);
				if (object==null)
					object = this.pageContext.getAttribute(replacedStr, PageContext.REQUEST_SCOPE);
				if (object!=null)
